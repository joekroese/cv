...
name: Jo
surname: Kroese
position: "Data scientist and artist"
...
aboutme: >
  Using data to help build a world that is more joyful and just.
headcolor: "414141"
output:
  vitae::awesomecv:
    keep_tex: true
...
tribble(
  ...
  list("Run a research organisation focused on how data science can be used as a tool for citizen empowerment through art, activism and policy.",
       ...
       "Spoken internationally on data art and activism including lectures at Edinburgh University and Université de Montréal and public talks such as Good Tech Fest in Chicago, Mozilla Festival in Amsterdam and Data Natives in Berlin."),
